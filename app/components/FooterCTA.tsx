...
export function FooterCTA() {
  ...
  return (
    <div id="call" ref={call} className="gap-5 md:gap-10 border border-border rounded-xl text-center px-0 md:px-10 py-5 pb-0 md:py-20 mt-10 md:mt-32 flex items-center flex-col bg-brand text-onBrand">
