    ...
    return (
      <div className="relative">
        ...
        <input
          type={inputType}
          className={cn(
            "flex tracking-wide h-14 w-full rounded-xl border bg-background hover:bg-muted hover:focus:bg-background px-12 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none hover:background focus-visible:border-brand focus-visible:border disabled:cursor-not-allowed disabled:opacity-50",
            className
          )}
          ref={ref}
          {...props}  
