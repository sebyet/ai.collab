...
export function Typography({ variant, children, className }: TypographyProps) {
  switch (variant) {
    case 'heading1':
      return (
        <h1 className={cn("font-bold text-4xl lg:text-5xl tracking-wide leading-relaxed text-pretty transition-colors", className)}>
          {children}
        </h1>
      );
    case 'heading2':
      return (
        <h2 className={cn("font-bold text-3xl lg:text-4xl tracking-wide leading-relaxed text-pretty transition-colors", className)}>
          {children}
        </h2>
      );
    case 'heading3':
      return (
        <h3 className={cn("text-2xl lg:text-3xl font-semibold tracking-wide leading-relaxed text-pretty", className)}>
          {children}
        </h3>
      );
    case 'heading4':
